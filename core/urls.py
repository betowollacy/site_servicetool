...
urlpatterns = [
    ...
    path('admin-panel/services/<str:svtype>/<int:service_id>/set-fields/', views_admin.admin_service_set_fields, name='admin_service_set_fields'),
...
path('admin-panel/apis/<int:api_id>/import/', views_admin.admin_api_import,
    ...
    path('admin-panel/apis/<int:api_id>/sync/', views_admin.admin_api_sync, name='admin_api_sync'),
    path('admin-panel/apis/<int:api_id>/map/', views_admin.admin_api_map, name='admin_api_map'),
    path('admin-panel/apis/db-export/', views_admin.admin_db_export, name='admin_db_export'),
    path('admin-panel/apis/db-import/', views_admin.admin_db_import, name='admin_db_import'),
    path('admin-panel/apis/link/', views_admin.admin_api_link, name='admin_api_link'),
    path('admin-panel/apis/fetch-images/', views_admin.admin_fetch_missing_thumbnails, name='admin_fetch_missing_thumbnails'),
    path('admin-panel/apis/<int:api_id>/delete/', views_admin.admin_api_delete, name='admin_api_delete'),
    ...
    path('admin-panel/relatorio-diario/', views_admin.admin_daily_report, name='admin_daily_report'),
    path('admin-panel/setting/', views_admin.admin_setting, name='admin_setting'),
    path('admin-panel/settings/unblock-ip/', views_admin.admin_unblock_ip, name='admin_unblock_ip'),
